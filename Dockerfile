...
COPY idps/wechat-mobile/0.0.8/keycloak-services-social-weixin-0.0.8.jar \
    /opt/jboss/keycloak/providers/

COPY idps/wechat-mobile/0.0.8/templates/realm-identity-provider-weixin-ext.html \
    /opt/jboss/keycloak/themes/base/admin/resources/partials

COPY idps/wechat-mobile/0.0.8/templates/realm-identity-provider-weixin.html \
    /opt/jboss/keycloak/themes/base/admin/resources/partials
